...
namespace PizzeriaServiceImplementDataBase.Implementations
{
    public class ReptServiceDB : IReptService
    {
        ...
        public ReptServiceDB(PizzeriaDbContext context)
        {
        ...
        public void SavePizzaPrice(ReptBindingModel model)
        {
            ...
            try
            {
               ...
               missing);
                ...
                var table = document.Tables.Add(rangeTable, pizzas.Count, 2, ref
               missing, ref missing);
        ...
        public List<StoragesLoadViewModel> GetStoragesLoad()
        {            return context.Storages
            ...
            .ToList(),
             stock => stock,
            stockIngredient => stockIngredient.Storage,
            (stock, stockCompList) =>
        ...
        public void SaveCustomerIndents(ReptBindingModel model)
        {
           ...
           iTextSharp.text.Font.BOLD);
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                table.AddCell(cell);
                cell = new PdfPCell(new Phrase(list[i].PizzaName, fontForCells));
                table.AddCell(cell);
